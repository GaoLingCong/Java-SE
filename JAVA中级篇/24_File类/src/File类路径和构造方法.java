...
FileSC("d:\\","a.txt");
     ...
     */
    private static void FileSC(String parent, String child){
     ...
     */
    private static  void FilePC(String parent,String chind){
        File file = new File(parent,chind);
        System.out.println(file);
    }
