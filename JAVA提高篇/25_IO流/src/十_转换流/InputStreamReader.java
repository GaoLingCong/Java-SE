...
public class InputStreamReader {
    ...
    private static void read_gbk() throws IOException {
        ...
        java.io.InputStreamReader isr = new java.io.InputStreamReader(new FileInputStream("10_IO\\gbk.txt"),"GBK");//你好
    ...
    private static void read_utf_8() throws IOException {
        ...
        java.io.InputStreamReader isr = new java.io.InputStreamReader(new FileInputStream("10_IO\\utf_8.txt"));//不指定默认使用UTF-8
        //2.使用InputStreamReader对象中的方法read读取文件
        int len = 0;
        while((len = isr.read())!=-1){
            System.out.println((char)len);
